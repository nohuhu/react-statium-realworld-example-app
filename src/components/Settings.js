...
import { getUserName, getUserImage, getUserBio, getUserEmail } from '../selectors/user.js';
import { saveUserSettings } from '../actions/user.js';
import { emailRe, urlRe, inputCls, haveErrors } from '../util/form.js';
...
const Settings = ({ username, image, bio, email }) => (
  <Store tag="Settings" state={{
      ...initialState,
      username,
      image: image || '',
      bio: bio || '',
